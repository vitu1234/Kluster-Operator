...
import (
	...
	vitudevv1alpha1 "github.com/vitu1234/kluster/pkg/apis/vitu.dev/v1alpha1"
	versioned "github.com/vitu1234/kluster/pkg/client/clientset/versioned"
	internalinterfaces "github.com/vitu1234/kluster/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/vitu1234/kluster/pkg/client/listers/vitu.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VituV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VituV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&vitudevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vitudevv1alpha1.Kluster{}, f.defaultInformer)
}
